"""autogenerated by genpy from baxter_msgs/SolvePositionIKRequest.msg. Do not edit."""
import sys
...
class SolvePositionIKRequest(genpy.Message):
  ...
  _type = "baxter_msgs/SolvePositionIKRequest"
...
"""autogenerated by genpy from baxter_msgs/SolvePositionIKResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SolvePositionIKResponse(genpy.Message):
  _md5sum = "fff7836a31ef390040c7cd2eb0e4eb04"
  _type = "baxter_msgs/SolvePositionIKResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """baxter_msgs/JointPositions[] joints
bool[] isValid
...
"""
  ...
  _slot_types = ['baxter_msgs/JointPositions[]','bool[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints = []
      for i in range(0, length):
        val1 = baxter_msgs.msg.JointPositions()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
...
class SolvePositionIK(object):
  _type          = 'baxter_msgs/SolvePositionIK'
  _md5sum = '188e1927e5dd412155e083fb8eb096db'
