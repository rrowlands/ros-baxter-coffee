"""autogenerated by genpy from baxter_msgs/OpenCameraRequest.msg. Do not edit."""
import sys
...
class OpenCameraRequest(genpy.Message):
  ...
  _type = "baxter_msgs/OpenCameraRequest"
...
"""
  ...
  _slot_types = ['string','baxter_msgs/CameraSettings']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.settings is None:
        self.settings = baxter_msgs.msg.CameraSettings()
    else:
      self.name = ''
      self.settings = baxter_msgs.msg.CameraSettings()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = baxter_msgs.msg.CameraControl()
        _x = val1
        start = end
        end += 8
...
"""autogenerated by genpy from baxter_msgs/OpenCameraResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class OpenCameraResponse(genpy.Message):
  ...
  _type = "baxter_msgs/OpenCameraResponse"
  _has_header = False #flag to mark the presence of a Header object
