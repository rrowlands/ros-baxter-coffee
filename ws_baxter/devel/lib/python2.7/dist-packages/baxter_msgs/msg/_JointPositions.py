"""autogenerated by genpy from baxter_msgs/JointPositions.msg. Do not edit."""
import sys
...
class JointPositions(genpy.Message):
  _md5sum = "a43c815223f80009ee6700b6d1dd906a"
  _type = "baxter_msgs/JointPositions"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Joint angles in radians:
float64[] angles
# A list of names associated with the above angles
string[]  names
"""
  __slots__ = ['angles','names']
