"""autogenerated by genpy from baxter_msgs/TareEnable.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['bool','string','baxter_msgs/TareData']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.data is None:
        self.data = baxter_msgs.msg.TareData()
    else:
      self.isEnabled = False
      self.uid = ''
      self.data = baxter_msgs.msg.TareData()
