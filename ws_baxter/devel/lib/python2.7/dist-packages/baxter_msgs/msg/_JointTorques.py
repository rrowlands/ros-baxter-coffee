"""autogenerated by genpy from baxter_msgs/JointTorques.msg. Do not edit."""
import sys
...
class JointTorques(genpy.Message):
  _md5sum = "cb08b7d29f7cc5d4cd9eb9a8edbbfce3"
  _type = "baxter_msgs/JointTorques"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Joint torques in Nm:
float64[] torques
# A list of names associated with the above torques
string[]  names

"""
  __slots__ = ['torques','names']
