"""autogenerated by genpy from baxter_msgs/DigitalIOStates.msg. Do not edit."""
import sys
...
class DigitalIOStates(genpy.Message):
  ...
  _type = "baxter_msgs/DigitalIOStates"
...
"""
  ...
  _slot_types = ['string[]','baxter_msgs/DigitalIOState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = baxter_msgs.msg.DigitalIOState()
        _x = val1
        start = end
        end += 2
