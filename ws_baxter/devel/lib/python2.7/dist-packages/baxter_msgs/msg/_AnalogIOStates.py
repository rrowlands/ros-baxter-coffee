"""autogenerated by genpy from baxter_msgs/AnalogIOStates.msg. Do not edit."""
import sys
...
class AnalogIOStates(genpy.Message):
  ...
  _type = "baxter_msgs/AnalogIOStates"
...
"""
  ...
  _slot_types = ['string[]','baxter_msgs/AnalogIOState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = baxter_msgs.msg.AnalogIOState()
        _v2 = val1.timestamp
        _x = _v2
        start = end
        end += 8
