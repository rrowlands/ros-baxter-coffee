...
(cl:defmethod cl:initialize-instance :after ((m <HeadPanCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeadPanCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<HeadPanCommand> is deprecated: use baxter_msgs-msg:HeadPanCommand instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <HeadPanCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:target-val is deprecated.  Use baxter_msgs-msg:target instead.")
  (target m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <HeadPanCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:speed-val is deprecated.  Use baxter_msgs-msg:speed instead.")
  (speed m))
