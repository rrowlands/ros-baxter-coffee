...
(cl:defmethod cl:initialize-instance :after ((m <AnalogIOState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnalogIOState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<AnalogIOState> is deprecated: use baxter_msgs-msg:AnalogIOState instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <AnalogIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:timestamp-val is deprecated.  Use baxter_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <AnalogIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:value-val is deprecated.  Use baxter_msgs-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'isInputOnly-val :lambda-list '(m))
(cl:defmethod isInputOnly-val ((m <AnalogIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:isInputOnly-val is deprecated.  Use baxter_msgs-msg:isInputOnly instead.")
  (isInputOnly m))
