...
(cl:defclass <CameraSettings> (roslisp-msg-protocol:ros-message)
  ((width
   ...
   (controls
    :reader controls
    :initarg :controls
    :type (cl:vector baxter_msgs-msg:CameraControl)
   :initform (cl:make-array 0 :element-type 'baxter_msgs-msg:CameraControl :initial-element (cl:make-instance 'baxter_msgs-msg:CameraControl))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CameraSettings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CameraSettings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<CameraSettings> is deprecated: use baxter_msgs-msg:CameraSettings instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <CameraSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:width-val is deprecated.  Use baxter_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <CameraSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:height-val is deprecated.  Use baxter_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'fps-val :lambda-list '(m))
(cl:defmethod fps-val ((m <CameraSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:fps-val is deprecated.  Use baxter_msgs-msg:fps instead.")
  (fps m))

(cl:ensure-generic-function 'controls-val :lambda-list '(m))
(cl:defmethod controls-val ((m <CameraSettings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:controls-val is deprecated.  Use baxter_msgs-msg:controls instead.")
  (controls m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CameraSettings>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'controls)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'baxter_msgs-msg:CameraControl))
