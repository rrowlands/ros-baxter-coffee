...
(cl:defmethod cl:initialize-instance :after ((m <JointVelocities>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointVelocities)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<JointVelocities> is deprecated: use baxter_msgs-msg:JointVelocities instead.")))

(cl:ensure-generic-function 'velocities-val :lambda-list '(m))
(cl:defmethod velocities-val ((m <JointVelocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:velocities-val is deprecated.  Use baxter_msgs-msg:velocities instead.")
  (velocities m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<JointVelocities>)))
  ...
  "0bb8c7b2e19f7c114eda9e374ead60da")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'JointVelocities)))
  "Returns md5sum for a message object of type 'JointVelocities"
  "0bb8c7b2e19f7c114eda9e374ead60da")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointVelocities>)))
  ...
  (cl:format cl:nil "# Joint velocities in radians/sec:~%float64[] velocities~%# A list of names associated with the above velocities~%string[]  names~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointVelocities)))
  "Returns full string definition for message of type 'JointVelocities"
  (cl:format cl:nil "# Joint velocities in radians/sec:~%float64[] velocities~%# A list of names associated with the above velocities~%string[]  names~%~%~%"))
