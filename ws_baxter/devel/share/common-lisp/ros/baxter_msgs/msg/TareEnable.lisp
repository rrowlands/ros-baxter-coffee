...
(cl:defclass <TareEnable> (roslisp-msg-protocol:ros-message)
  ((isEnabled
   ...
   (data
    :reader data
    :initarg :data
    :type baxter_msgs-msg:TareData
    :initform (cl:make-instance 'baxter_msgs-msg:TareData)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TareEnable>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TareEnable)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<TareEnable> is deprecated: use baxter_msgs-msg:TareEnable instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TareEnable>)))
  ...
  (cl:format cl:nil "bool isEnabled~%string uid~%baxter_msgs/TareData data~%~%================================================================================~%MSG: baxter_msgs/TareData~%bool tuneGravitySpring~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TareEnable)))
  "Returns full string definition for message of type 'TareEnable"
  (cl:format cl:nil "bool isEnabled~%string uid~%baxter_msgs/TareData data~%~%================================================================================~%MSG: baxter_msgs/TareData~%bool tuneGravitySpring~%~%~%"))
