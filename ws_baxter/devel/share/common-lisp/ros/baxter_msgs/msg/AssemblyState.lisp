...
(cl:defmethod cl:initialize-instance :after ((m <AssemblyState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssemblyState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<AssemblyState> is deprecated: use baxter_msgs-msg:AssemblyState instead.")))
...
(cl:defmethod stopped-val ((m <AssemblyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:stopped-val is deprecated.  Use baxter_msgs-msg:stopped instead.")
  (stopped m))
...
(cl:defmethod estop_button-val ((m <AssemblyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:estop_button-val is deprecated.  Use baxter_msgs-msg:estop_button instead.")
  (estop_button m))

(cl:ensure-generic-function 'estop_source-val :lambda-list '(m))
(cl:defmethod estop_source-val ((m <AssemblyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:estop_source-val is deprecated.  Use baxter_msgs-msg:estop_source instead.")
  (estop_source m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AssemblyState>)))
  ...
  "d7ff2b9fa7d5f688665ce44db4ee2af8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AssemblyState)))
  "Returns md5sum for a message object of type 'AssemblyState"
  "d7ff2b9fa7d5f688665ce44db4ee2af8")
