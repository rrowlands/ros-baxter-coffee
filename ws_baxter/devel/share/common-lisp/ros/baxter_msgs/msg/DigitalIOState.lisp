...
(cl:defmethod cl:initialize-instance :after ((m <DigitalIOState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalIOState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<DigitalIOState> is deprecated: use baxter_msgs-msg:DigitalIOState instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <DigitalIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:state-val is deprecated.  Use baxter_msgs-msg:state instead.")
  (state m))
