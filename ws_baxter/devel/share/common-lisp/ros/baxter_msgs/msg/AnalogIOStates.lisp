...
(cl:defclass <AnalogIOStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector baxter_msgs-msg:AnalogIOState)
   :initform (cl:make-array 0 :element-type 'baxter_msgs-msg:AnalogIOState :initial-element (cl:make-instance 'baxter_msgs-msg:AnalogIOState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AnalogIOStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnalogIOStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<AnalogIOStates> is deprecated: use baxter_msgs-msg:AnalogIOStates instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AnalogIOStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'baxter_msgs-msg:AnalogIOState))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AnalogIOStates>)))
  ...
  (cl:format cl:nil "string[]         names~%AnalogIOState[] states~%================================================================================~%MSG: baxter_msgs/AnalogIOState~%time timestamp~%float64 value~%bool isInputOnly~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AnalogIOStates)))
  "Returns full string definition for message of type 'AnalogIOStates"
  (cl:format cl:nil "string[]         names~%AnalogIOState[] states~%================================================================================~%MSG: baxter_msgs/AnalogIOState~%time timestamp~%float64 value~%bool isInputOnly~%~%~%"))
