...
(cl:defmethod cl:initialize-instance :after ((m <UpdateSource>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateSource)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<UpdateSource> is deprecated: use baxter_msgs-msg:UpdateSource instead.")))

(cl:ensure-generic-function 'devname-val :lambda-list '(m))
(cl:defmethod devname-val ((m <UpdateSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:devname-val is deprecated.  Use baxter_msgs-msg:devname instead.")
  (devname m))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <UpdateSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:filename-val is deprecated.  Use baxter_msgs-msg:filename instead.")
  (filename m))

(cl:ensure-generic-function 'version-val :lambda-list '(m))
(cl:defmethod version-val ((m <UpdateSource>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:version-val is deprecated.  Use baxter_msgs-msg:version instead.")
  (version m))
