...
(cl:defmethod cl:initialize-instance :after ((m <TareData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TareData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<TareData> is deprecated: use baxter_msgs-msg:TareData instead.")))

(cl:ensure-generic-function 'tuneGravitySpring-val :lambda-list '(m))
(cl:defmethod tuneGravitySpring-val ((m <TareData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:tuneGravitySpring-val is deprecated.  Use baxter_msgs-msg:tuneGravitySpring instead.")
  (tuneGravitySpring m))
