...
(cl:defmethod cl:initialize-instance :after ((m <HeadState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeadState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<HeadState> is deprecated: use baxter_msgs-msg:HeadState instead.")))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <HeadState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:pan-val is deprecated.  Use baxter_msgs-msg:pan instead.")
  (pan m))

(cl:ensure-generic-function 'isPanning-val :lambda-list '(m))
(cl:defmethod isPanning-val ((m <HeadState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:isPanning-val is deprecated.  Use baxter_msgs-msg:isPanning instead.")
  (isPanning m))

(cl:ensure-generic-function 'isNodding-val :lambda-list '(m))
(cl:defmethod isNodding-val ((m <HeadState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:isNodding-val is deprecated.  Use baxter_msgs-msg:isNodding instead.")
  (isNodding m))
