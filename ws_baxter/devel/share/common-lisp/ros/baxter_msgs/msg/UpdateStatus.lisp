...
(cl:defmethod cl:initialize-instance :after ((m <UpdateStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<UpdateStatus> is deprecated: use baxter_msgs-msg:UpdateStatus instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <UpdateStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:status-val is deprecated.  Use baxter_msgs-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'progress-val :lambda-list '(m))
(cl:defmethod progress-val ((m <UpdateStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:progress-val is deprecated.  Use baxter_msgs-msg:progress instead.")
  (progress m))

(cl:ensure-generic-function 'long_description-val :lambda-list '(m))
(cl:defmethod long_description-val ((m <UpdateStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:long_description-val is deprecated.  Use baxter_msgs-msg:long_description instead.")
  (long_description m))
