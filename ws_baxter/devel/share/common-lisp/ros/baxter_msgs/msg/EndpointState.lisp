...
(cl:defmethod cl:initialize-instance :after ((m <EndpointState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<EndpointState> is deprecated: use baxter_msgs-msg:EndpointState instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:pose-val is deprecated.  Use baxter_msgs-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:twist-val is deprecated.  Use baxter_msgs-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'wrench-val :lambda-list '(m))
(cl:defmethod wrench-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:wrench-val is deprecated.  Use baxter_msgs-msg:wrench instead.")
  (wrench m))
