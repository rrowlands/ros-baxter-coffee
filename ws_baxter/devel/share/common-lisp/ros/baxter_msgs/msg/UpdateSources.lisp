...
(cl:defclass <UpdateSources> (roslisp-msg-protocol:ros-message)
  ((uuid
   ...
   (sources
    :reader sources
    :initarg :sources
    :type (cl:vector baxter_msgs-msg:UpdateSource)
   :initform (cl:make-array 0 :element-type 'baxter_msgs-msg:UpdateSource :initial-element (cl:make-instance 'baxter_msgs-msg:UpdateSource))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <UpdateSources>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateSources)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<UpdateSources> is deprecated: use baxter_msgs-msg:UpdateSources instead.")))

(cl:ensure-generic-function 'uuid-val :lambda-list '(m))
(cl:defmethod uuid-val ((m <UpdateSources>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:uuid-val is deprecated.  Use baxter_msgs-msg:uuid instead.")
  (uuid m))

(cl:ensure-generic-function 'sources-val :lambda-list '(m))
(cl:defmethod sources-val ((m <UpdateSources>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:sources-val is deprecated.  Use baxter_msgs-msg:sources instead.")
  (sources m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <UpdateSources>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'sources)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'baxter_msgs-msg:UpdateSource))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<UpdateSources>)))
  ...
  (cl:format cl:nil "string          uuid~%UpdateSource[]  sources~%~%================================================================================~%MSG: baxter_msgs/UpdateSource~%string  devname~%string  filename~%string  version~%string  uuid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'UpdateSources)))
  "Returns full string definition for message of type 'UpdateSources"
  (cl:format cl:nil "string          uuid~%UpdateSource[]  sources~%~%================================================================================~%MSG: baxter_msgs/UpdateSource~%string  devname~%string  filename~%string  version~%string  uuid~%~%~%"))
