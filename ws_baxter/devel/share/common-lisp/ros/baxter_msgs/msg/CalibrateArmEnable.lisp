...
(cl:defmethod cl:initialize-instance :after ((m <CalibrateArmEnable>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalibrateArmEnable)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<CalibrateArmEnable> is deprecated: use baxter_msgs-msg:CalibrateArmEnable instead.")))
...
(cl:defmethod uid-val ((m <CalibrateArmEnable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:uid-val is deprecated.  Use baxter_msgs-msg:uid instead.")
  (uid m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <CalibrateArmEnable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:data-val is deprecated.  Use baxter_msgs-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalibrateArmEnable>)))
  ...
  "baxter_msgs/CalibrateArmEnable")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalibrateArmEnable)))
  "Returns string type for a message object of type 'CalibrateArmEnable"
  "baxter_msgs/CalibrateArmEnable")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CalibrateArmEnable>)))
  ...
  "e29cddd6c5825de42ce8309f5f9cb399")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CalibrateArmEnable)))
  "Returns md5sum for a message object of type 'CalibrateArmEnable"
  "e29cddd6c5825de42ce8309f5f9cb399")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CalibrateArmEnable>)))
  ...
  (cl:format cl:nil "## @file CalibrateArmEnable.msg See the file below for additional documentation~%## @addtogroup RobustControllersMsgs~%## @{~%## @class RobustControllersMsgs::CalibrateArmEnable~%~%bool isEnabled~%string uid~%std_msgs/Empty data~%~%## @}~%~%================================================================================~%MSG: std_msgs/Empty~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CalibrateArmEnable)))
  "Returns full string definition for message of type 'CalibrateArmEnable"
  (cl:format cl:nil "## @file CalibrateArmEnable.msg See the file below for additional documentation~%## @addtogroup RobustControllersMsgs~%## @{~%## @class RobustControllersMsgs::CalibrateArmEnable~%~%bool isEnabled~%string uid~%std_msgs/Empty data~%~%## @}~%~%================================================================================~%MSG: std_msgs/Empty~%~%~%"))
