...
(cl:defclass <ITBStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector baxter_msgs-msg:ITB)
   :initform (cl:make-array 0 :element-type 'baxter_msgs-msg:ITB :initial-element (cl:make-instance 'baxter_msgs-msg:ITB))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ITBStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ITBStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<ITBStates> is deprecated: use baxter_msgs-msg:ITBStates instead.")))
...
(cl:defmethod states-val ((m <ITBStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:states-val is deprecated.  Use baxter_msgs-msg:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ITBStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'baxter_msgs-msg:ITB))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ITBStates>)))
  ...
  (cl:format cl:nil "# used when publishing multiple itbs~%string[]         names~%ITB[] states~%================================================================================~%MSG: baxter_msgs/ITB~%bool[4] buttons~%bool    up~%bool    down~%bool    left~%bool    right~%uint8   wheel~%~%~%# true if the inner light is on, false if not~%bool innerLight~%~%# true if the outer light is on, false if not~%bool outerLight~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ITBStates)))
  "Returns full string definition for message of type 'ITBStates"
  (cl:format cl:nil "# used when publishing multiple itbs~%string[]         names~%ITB[] states~%================================================================================~%MSG: baxter_msgs/ITB~%bool[4] buttons~%bool    up~%bool    down~%bool    left~%bool    right~%uint8   wheel~%~%~%# true if the inner light is on, false if not~%bool innerLight~%~%# true if the outer light is on, false if not~%bool outerLight~%~%~%"))
