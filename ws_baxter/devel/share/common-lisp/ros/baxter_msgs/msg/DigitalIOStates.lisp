...
(cl:defclass <DigitalIOStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector baxter_msgs-msg:DigitalIOState)
   :initform (cl:make-array 0 :element-type 'baxter_msgs-msg:DigitalIOState :initial-element (cl:make-instance 'baxter_msgs-msg:DigitalIOState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DigitalIOStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalIOStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<DigitalIOStates> is deprecated: use baxter_msgs-msg:DigitalIOStates instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DigitalIOStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'baxter_msgs-msg:DigitalIOState))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DigitalIOStates>)))
  ...
  (cl:format cl:nil "string[]         names~%DigitalIOState[] states~%================================================================================~%MSG: baxter_msgs/DigitalIOState~%int8 state~%bool isInputOnly~%~%int8 OFF = 0~%int8 ON  = 1~%int8 PRESSED = 1~%int8 UNPRESSED = 0~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DigitalIOStates)))
  "Returns full string definition for message of type 'DigitalIOStates"
  (cl:format cl:nil "string[]         names~%DigitalIOState[] states~%================================================================================~%MSG: baxter_msgs/DigitalIOState~%int8 state~%bool isInputOnly~%~%int8 OFF = 0~%int8 ON  = 1~%int8 PRESSED = 1~%int8 UNPRESSED = 0~%~%"))
