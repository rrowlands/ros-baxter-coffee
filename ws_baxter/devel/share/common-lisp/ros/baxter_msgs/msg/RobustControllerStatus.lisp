...
(cl:defmethod cl:initialize-instance :after ((m <RobustControllerStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobustControllerStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-msg:<RobustControllerStatus> is deprecated: use baxter_msgs-msg:RobustControllerStatus instead.")))

(cl:ensure-generic-function 'isEnabled-val :lambda-list '(m))
(cl:defmethod isEnabled-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:isEnabled-val is deprecated.  Use baxter_msgs-msg:isEnabled instead.")
  (isEnabled m))

(cl:ensure-generic-function 'complete-val :lambda-list '(m))
(cl:defmethod complete-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:complete-val is deprecated.  Use baxter_msgs-msg:complete instead.")
  (complete m))

(cl:ensure-generic-function 'controlUid-val :lambda-list '(m))
(cl:defmethod controlUid-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:controlUid-val is deprecated.  Use baxter_msgs-msg:controlUid instead.")
  (controlUid m))

(cl:ensure-generic-function 'timedOut-val :lambda-list '(m))
(cl:defmethod timedOut-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:timedOut-val is deprecated.  Use baxter_msgs-msg:timedOut instead.")
  (timedOut m))

(cl:ensure-generic-function 'errorCodes-val :lambda-list '(m))
(cl:defmethod errorCodes-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-msg:errorCodes-val is deprecated.  Use baxter_msgs-msg:errorCodes instead.")
  (errorCodes m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobustControllerStatus>)))
  ...
  "baxter_msgs/RobustControllerStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobustControllerStatus)))
  "Returns string type for a message object of type 'RobustControllerStatus"
  "baxter_msgs/RobustControllerStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobustControllerStatus>)))
  ...
  "a67397a3739e5b483e83ba6f4f4f09b1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobustControllerStatus)))
  "Returns md5sum for a message object of type 'RobustControllerStatus"
  "a67397a3739e5b483e83ba6f4f4f09b1")
