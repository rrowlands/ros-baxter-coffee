...
(cl:defmethod cl:initialize-instance :after ((m <LSCores-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LSCores-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<LSCores-request> is deprecated: use baxter_msgs-srv:LSCores-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <LSCores-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LSCores-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<LSCores-response> is deprecated: use baxter_msgs-srv:LSCores-response instead.")))

(cl:ensure-generic-function 'cores-val :lambda-list '(m))
(cl:defmethod cores-val ((m <LSCores-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:cores-val is deprecated.  Use baxter_msgs-srv:cores instead.")
  (cores m))
