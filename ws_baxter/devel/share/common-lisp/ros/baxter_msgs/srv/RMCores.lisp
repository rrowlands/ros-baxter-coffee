...
(cl:defmethod cl:initialize-instance :after ((m <RMCores-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RMCores-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<RMCores-request> is deprecated: use baxter_msgs-srv:RMCores-request instead.")))

(cl:ensure-generic-function 'core-val :lambda-list '(m))
(cl:defmethod core-val ((m <RMCores-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:core-val is deprecated.  Use baxter_msgs-srv:core instead.")
  (core m))
...
(cl:defmethod cl:initialize-instance :after ((m <RMCores-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RMCores-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<RMCores-response> is deprecated: use baxter_msgs-srv:RMCores-response instead.")))
...
(cl:defmethod err_str-val ((m <RMCores-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:err_str-val is deprecated.  Use baxter_msgs-srv:err_str instead.")
  (err_str m))
