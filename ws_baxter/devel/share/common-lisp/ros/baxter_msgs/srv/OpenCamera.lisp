...
(cl:defclass <OpenCamera-request> (roslisp-msg-protocol:ros-message)
  ((name
   ...
   (settings
    :reader settings
    :initarg :settings
    :type baxter_msgs-msg:CameraSettings
    :initform (cl:make-instance 'baxter_msgs-msg:CameraSettings)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <OpenCamera-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OpenCamera-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<OpenCamera-request> is deprecated: use baxter_msgs-srv:OpenCamera-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <OpenCamera-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:name-val is deprecated.  Use baxter_msgs-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'settings-val :lambda-list '(m))
(cl:defmethod settings-val ((m <OpenCamera-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:settings-val is deprecated.  Use baxter_msgs-srv:settings instead.")
  (settings m))
...
(cl:defmethod cl:initialize-instance :after ((m <OpenCamera-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OpenCamera-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<OpenCamera-response> is deprecated: use baxter_msgs-srv:OpenCamera-response instead.")))

(cl:ensure-generic-function 'err-val :lambda-list '(m))
(cl:defmethod err-val ((m <OpenCamera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:err-val is deprecated.  Use baxter_msgs-srv:err instead.")
  (err m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OpenCamera-response>)))
  ...
  "baxter_msgs/OpenCameraResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OpenCamera-response)))
  "Returns string type for a service object of type 'OpenCamera-response"
  "baxter_msgs/OpenCameraResponse")
