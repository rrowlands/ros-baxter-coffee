...
(cl:defmethod cl:initialize-instance :after ((m <SolvePositionIK-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SolvePositionIK-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<SolvePositionIK-request> is deprecated: use baxter_msgs-srv:SolvePositionIK-request instead.")))

(cl:ensure-generic-function 'pose_stamp-val :lambda-list '(m))
(cl:defmethod pose_stamp-val ((m <SolvePositionIK-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:pose_stamp-val is deprecated.  Use baxter_msgs-srv:pose_stamp instead.")
  (pose_stamp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SolvePositionIK-request>)))
  ...
  "baxter_msgs/SolvePositionIKRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SolvePositionIK-request)))
  "Returns string type for a service object of type 'SolvePositionIK-request"
  "baxter_msgs/SolvePositionIKRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SolvePositionIK-request>)))
  ...
  "188e1927e5dd412155e083fb8eb096db")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SolvePositionIK-request)))
  "Returns md5sum for a message object of type 'SolvePositionIK-request"
  "188e1927e5dd412155e083fb8eb096db")
...
(cl:defclass <SolvePositionIK-response> (roslisp-msg-protocol:ros-message)
  ((joints
    :reader joints
    :initarg :joints
    :type (cl:vector baxter_msgs-msg:JointPositions)
   :initform (cl:make-array 0 :element-type 'baxter_msgs-msg:JointPositions :initial-element (cl:make-instance 'baxter_msgs-msg:JointPositions)))
   (isValid
    :reader isValid
    :initarg :isValid
...
(cl:defmethod cl:initialize-instance :after ((m <SolvePositionIK-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SolvePositionIK-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_msgs-srv:<SolvePositionIK-response> is deprecated: use baxter_msgs-srv:SolvePositionIK-response instead.")))

(cl:ensure-generic-function 'joints-val :lambda-list '(m))
(cl:defmethod joints-val ((m <SolvePositionIK-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:joints-val is deprecated.  Use baxter_msgs-srv:joints instead.")
  (joints m))

(cl:ensure-generic-function 'isValid-val :lambda-list '(m))
(cl:defmethod isValid-val ((m <SolvePositionIK-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_msgs-srv:isValid-val is deprecated.  Use baxter_msgs-srv:isValid instead.")
  (isValid m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SolvePositionIK-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'joints)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'baxter_msgs-msg:JointPositions))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SolvePositionIK-response>)))
  ...
  "baxter_msgs/SolvePositionIKResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SolvePositionIK-response)))
  "Returns string type for a service object of type 'SolvePositionIK-response"
  "baxter_msgs/SolvePositionIKResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SolvePositionIK-response>)))
  ...
  (cl:format cl:nil "baxter_msgs/JointPositions[] joints~%bool[] isValid~%~%~%================================================================================~%MSG: baxter_msgs/JointPositions~%# Joint angles in radians:~%float64[] angles~%# A list of names associated with the above angles~%string[]  names~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SolvePositionIK-response)))
  "Returns full string definition for message of type 'SolvePositionIK-response"
  (cl:format cl:nil "baxter_msgs/JointPositions[] joints~%bool[] isValid~%~%~%================================================================================~%MSG: baxter_msgs/JointPositions~%# Joint angles in radians:~%float64[] angles~%# A list of names associated with the above angles~%string[]  names~%~%"))
