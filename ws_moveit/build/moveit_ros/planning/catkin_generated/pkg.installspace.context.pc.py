...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lmoveit_rdf_loader;-lmoveit_kinematics_plugin_loader;-lmoveit_robot_model_loader;-lmoveit_constraint_sampler_manager_loader;-lmoveit_planning_pipeline;-lmoveit_trajectory_execution_manager;-lmoveit_plan_execution;-lmoveit_planning_scene_monitor".split(';') if "-lmoveit_rdf_loader;-lmoveit_kinematics_plugin_loader;-lmoveit_robot_model_loader;-lmoveit_constraint_sampler_manager_loader;-lmoveit_planning_pipeline;-lmoveit_trajectory_execution_manager;-lmoveit_plan_execution;-lmoveit_planning_scene_monitor" != "" else []
